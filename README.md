...
Built by [Vic Paulson](https://www.openlunar.org/vic) for the 2026 Open Lunar Foundation fellowship. See the Acknowledgments section for full credits. The zone geometry comes from Paulson and Roberts, [Modeling Safety-Zone Interactions and Resource Access in Lunar South-Pole PSRs](https://www.researchgate.net/publication/399733797_Modeling_Safety-Zone_Interactions_and_Resource_Access_in_Lunar_South-Pole_PSRs) (AIAA SciTech 2026); the ISRU economics from Paulson, Balchanos, and Mavris, [Simulating Economic and Environmental Trade-Offs in Lunar Water Supply: ISRU vs. Earth Resupply](https://www.researchgate.net/publication/400096148_Simulating_Economic_and_Environmental_Trade-Offs_in_Lunar_Water_Supply_ISRU_vs_Earth_Resupply) (AIAA SciTech 2026); the terrain scoring comes from the LFI, SOFI, and IFI favorability indices from the same research line.
