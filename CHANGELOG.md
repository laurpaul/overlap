...
## v215 licensing (July 8, 2026)

Final license structure: the code is free to use under the permissive terms
in LICENSE (use, copy, modify, workshops included), with a stated
non-binding request that workshop runners send back their session export
CSVs, since playtest data is how the tool improves. Datasets, figures, and
docs are CC BY 4.0. Package stays private: true as an npm publish guard.
